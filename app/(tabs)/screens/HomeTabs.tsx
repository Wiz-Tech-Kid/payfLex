...
export default function Home() {
  ...
  const handleMakePayment = () => {
    router.push('/(tabs)/screens/SendMoneyScreen');
  };
  const handleNewLoan = () => {
    router.push('/(tabs)/screens/LoanApplication');
  };
  const handleLoanCalculator = () => {
    router.push('/(tabs)/screens/SimulatorScreen');
  };
  const handleRecentPayments = () => {
    router.push('/(tabs)/screens/SendMoneyScreen'); // adjust if you have a payments screen
  };
  ...
  const handleSidebarNav = (route: string) => {
    ...
    router.push(`/(tabs)/screens/${route}`);
  };
  const handleLogout = () => {
    setSidebarOpen(false);
  ...
  <Text style={styles.quickActionTitle}>New Loan</Text> {/* Changed from quickActionText */}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.paymentMethods}>
              ...
              <TouchableOpacity style={styles.paymentMethod} onPress={handleMobileWallet}>
                <Text style={styles.phoneIcon}>📱</Text>
                <Text style={styles.paymentMethodText}>Mobile Wallet</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.paymentMethod} onPress={handleQRCode}>
                <Text style={styles.qrIcon}>⬜</Text>
                <Text style={styles.paymentMethodText}>QR Code</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.paymentMethod} onPress={handleUSSDPayment}>
